...
//        }
      ...
      stroke(0, lineAlpha); // < ----- alpha depends on distance of the points  
      strokeCap(ROUND);
  ...
  void setColor() {
    ...
    if (ani.section.equals("U.S.")) {
      hueValue = 10;
    }
    if (ani.section.equals("World")) {
      hueValue = 50;
    }
    if (ani.section.equals("N.Y. / Region")) {
      hueValue = 300;
    }
    ...
    if (ani.section.equals("Books")) {
      hueValue = 320;
    }
    if (ani.section.equals("Movies")) {
      hueValue = 280;
    }
    if (ani.section.equals("Technology")) {
      hueValue = 220;
    }
    if (ani.section.equals("Science")) {
      hueValue = 160;
    }
    if (ani.section.equals("Dining & Wine")) {
      hueValue = 20;
    }
    if (ani.section.equals("Health")) {  // nice purple pink
      hueValue = 240;
    }
    if (ani.section.equals("Style")) {
      hueValue = 35;
      brightnessValue = 70;
    }
    ...
    if (ani.section.equals("Magazine")) {  // nice, purple pink
      hueValue = 270;
    }
    if (ani.section.equals("Business Day")) {  // fine, real blue
      hueValue = 200;
    }
